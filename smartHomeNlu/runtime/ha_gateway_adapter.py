    ...
    def tool_call(self, tool_name: str, params: Dict[str, Any] | None = None) -> Dict[str, Any]:
        ...
        if self.mode == "stub":
            ...
            if tool_name == "ha_create_automation":
                return {"success": True, "status_code": 200, "automation_id": "automation.runtime_generated"}
        ...
        if tool_name in {"ha_create_automation", "ha_remove_automation"}:
            mapped_name = "ha_config_set_automation" if tool_name == "ha_create_automation" else "ha_config_remove_automation"
            resp = self._gateway_call(
                "tool_call",
                {
                    "name": mapped_name,
            ...
            if tool_name == "ha_create_automation":
                return {
                    "success": True,
                    "status_code": 200,
                    "automation_id": payload.get("entity_id") or payload.get("automation_id"),
                }
            return {"success": True, "status_code": 200}

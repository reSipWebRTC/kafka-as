...
watch_alerts_raw="${PREPROD_WATCH_ALERTS:-GatewayWsErrorRateHigh,DownlinkErrorRateHigh,CommandDispatchSuccessRateLow,CommandConfirmTimeoutRateHigh,CommandExecutionFailureRateHigh,CommandPipelineE2EP95LatencyHigh,PipelineErrorRateHigh,AsrPipelineP95LatencyHigh,TranslationPipelineP95LatencyHigh,TtsPipelineP95LatencyHigh,KafkaConsumerLagHigh,ControlPlaneAuthDenyRateHigh,ControlPlaneExternalIamUnavailableSpike,ControlPlaneHybridFallbackSpike}"

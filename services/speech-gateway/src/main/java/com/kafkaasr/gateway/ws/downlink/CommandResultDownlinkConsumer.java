...
public class CommandResultDownlinkConsumer {
    ...
    public void onMessage(String payload) {
        ...
        try {
            ...
            CommandResultPayload resultPayload = event.payload();
            downlinkPublisher.publishCommandResult(
                            event.sessionId(),
                            event.seq(),
                            resultPayload == null ? "" : resultPayload.executionId(),
                            resultPayload == null ? "" : resultPayload.status(),
                            resultPayload == null ? "" : resultPayload.code(),
                            resultPayload == null ? "" : resultPayload.replyText(),
                            resultPayload != null && resultPayload.retryable(),
                            resultPayload == null ? "" : resultPayload.confirmToken(),
                            resultPayload == null ? 0 : resultPayload.expiresInSec())
                    .block();
